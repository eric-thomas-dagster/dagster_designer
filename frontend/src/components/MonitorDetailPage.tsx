...
import {
  ...
  Trash2, FileText, Zap, Radar, Layers, Send, X,
} from 'lucide-react';
 ...
 */
export function MonitorDetailPage({ monitor, projectId, isDagsterPlus = false, onBack, onOpenFile, onOpenAsset, onDeleted }: MonitorDetailPageProps) {
